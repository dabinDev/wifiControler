        ...
        children: [
          ...
          Container(
            ...
            child: Wrap(
              ...
              children: [
                ElevatedButton.icon(
                  onPressed: _networkReady ? () => _executeTakePhoto(ControlMessage(type: MessageTypes.cmdTakePhoto, from: _deviceId)) : null,
                  icon: const Icon(Icons.camera_alt),
                  label: const Text('拍照'),
                ),
                ElevatedButton.icon(
                  onPressed: _networkReady ? () => _executeRecordStart(ControlMessage(type: MessageTypes.cmdRecordStart, from: _deviceId)) : null,
                  icon: const Icon(Icons.videocam),
                  label: const Text('录像'),
                ),
                ElevatedButton.icon(
                  onPressed: _networkReady ? () => _executeAudioStart(ControlMessage(type: MessageTypes.cmdAudioStart, from: _deviceId)) : null,
